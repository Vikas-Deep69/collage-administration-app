...
import databaseU,view_assignment

class edit_assignment:
    def __init__(self,frame,gup):
        self.frame2=frame
        self.gup1=gup
        self.teacher_info = databaseU.getbyassignment(gup)
    ...
    def update_material(self):
        ...
        # Call your databaseU update function
        success = databaseU.updateAssignment(self.gup1, new_course, new_department, new_subject,new_Number)
        if success:
