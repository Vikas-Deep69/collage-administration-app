...
import databaseU,view_material

class edit_material:
    def __init__(self,frame,gup):
        self.frame2=frame
        self.gup1=gup
        self.teacher_info = databaseU.getbytopic(gup)
    ...
    def update_material(self):
        ...
        success = databaseU.updateMaterial(self.gup1, new_course, new_department, new_subject,new_topic)
        if success:
