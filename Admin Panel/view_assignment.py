...
import databaseU,edit_assignment
from tkinter.ttk import Treeview
 
class view_assignment():
    def __init__(self, frame):
        self.frame1=frame
        self.lbl=Label(self.frame1,text="ASSIGNMENT",bg='white',fg='black',border=0,font=("JUST Sans",15))
    ...
    def actions(self,e):
        ...
        if col == '#6':
            ...
            if res:
                re = databaseU.delAssignment(gup)
                if re:
